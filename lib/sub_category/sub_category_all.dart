...
class _AllSubCategoryState extends State<AllSubCategory>with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('All',style: TextStyle(color:Colors.black45),)),
        actions: [
          IconButton(
             onPressed: (){},
